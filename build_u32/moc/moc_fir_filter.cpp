/****************************************************************************
** Meta object code from reading C++ file 'fir_filter.h'
**
...
#include "../../src_project_independent/fir_filter.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'fir_filter.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_FirFilter[] = {
    "FirFilter\0\0closeApp()\0number\0"
    "changed(int8_t)\0slCloseApp()\0"
};
...
void FirFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->changed((*reinterpret_cast< int8_t(*)>(_a[1]))); break;
        case 2: _t->slCloseApp(); break;
        default: ;
        }
    }
}
